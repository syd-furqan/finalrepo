...
/**
 * Admin policy screen for credential verification rule configuration (US-16).
 * Pattern: Single-document settings editor fragment.
 * Known issue: banned identifiers use CSV text for simpler editing in v1.
 */
